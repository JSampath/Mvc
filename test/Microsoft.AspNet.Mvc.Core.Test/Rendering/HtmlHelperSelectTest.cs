...
namespace Microsoft.AspNet.Mvc.Rendering
{
    public class HtmlHelperSelectTest
    {
        ...
        [Fact]
        public void GetSelectListTEnum_ThrowsWithFlagsEnum()
        {
            // Arrange
            ...
            ExceptionAssert.ThrowsArgument(
                () => htmlHelper.GetSelectList<EnumWithFlags>(),
                "TEnum",
                $"The type '{ typeof(EnumWithFlags).FullName }' is not supported.");
        }

        [Fact]
        public void GetSelectListTEnum_ThrowsWithNonEnum()
        {
            // Arrange
            var metadataProvider = TestModelMetadataProvider.CreateDefaultProvider();
            var htmlHelper = new TestHtmlHelper(metadataProvider);
            ...
            // Act & Assert
            ExceptionAssert.ThrowsArgument(
                () => htmlHelper.GetSelectList<StructWithFields>(),
                "TEnum",
                $"The type '{ typeof(StructWithFields).FullName }' is not supported.");
        }

        [Fact]
        public void GetSelectListTEnum_WrapsGetSelectListModelMetadata()
        {
            // Arrange
            var metadataProvider = TestModelMetadataProvider.CreateDefaultProvider();
            ...
            // Act
            var result = htmlHelper.GetSelectList<EnumWithFields>();
        ...
        [Fact]
        public void GetSelectListType_ThrowsWithFlagsEnum()
        {
            // Arrange
            var metadataProvider = TestModelMetadataProvider.CreateDefaultProvider();
            var htmlHelper = new TestHtmlHelper(metadataProvider);
            ...
            // Act & Assert
            ExceptionAssert.ThrowsArgument(
                () => htmlHelper.GetSelectList(typeof(EnumWithFlags)),
                "enumType",
                $"The type '{ typeof(EnumWithFlags).FullName }' is not supported.");
        }

        [Fact]
        public void GetSelectListType_ThrowsWithNonEnum()
        {
            // Arrange
            var metadataProvider = TestModelMetadataProvider.CreateDefaultProvider();
            var htmlHelper = new TestHtmlHelper(metadataProvider);
            ...
            // Act & Assert
            ExceptionAssert.ThrowsArgument(
                () => htmlHelper.GetSelectList(typeof(StructWithFields)),
                "enumType",
                $"The type '{ typeof(StructWithFields).FullName }' is not supported.");
        }

        [Fact]
        public void GetSelectListType_ThrowsWithNonStruct()
        {
            // Arrange
            var metadataProvider = TestModelMetadataProvider.CreateDefaultProvider();
            var htmlHelper = new TestHtmlHelper(metadataProvider);
            ...
            // Act & Assert
            ExceptionAssert.ThrowsArgument(
                () => htmlHelper.GetSelectList(typeof(ClassWithFields)),
                "enumType",
                $"The type '{ typeof(ClassWithFields).FullName }' is not supported.");
        }

        [Fact]
        public void GetSelectListType_WrapsGetSelectListModelMetadata()
        {
            // Arrange
            var metadataProvider = TestModelMetadataProvider.CreateDefaultProvider();
            var metadata = metadataProvider.GetMetadataForType(typeof(EnumWithFields));
            ...
            // Act
            var result = htmlHelper.GetSelectList(typeof(EnumWithFields));
        ...
        public static TheoryData<Type, IEnumerable<SelectListItem>> GetSelectListData
        {
            get
            {
        ...
        [Theory]
        [MemberData(nameof(GetSelectListData))]
        public void GetSelectList_ReturnsExpectedItems(Type type, IEnumerable<SelectListItem> expected)
        {
            // Arrange
            var metadataProvider = TestModelMetadataProvider.CreateDefaultProvider();
            ...
            // Act
            var result = htmlHelper.GetSelectList(type);
        ...
        private class TestHtmlHelper : HtmlHelper
        {
            ...
            protected override IEnumerable<SelectListItem> GetSelectList([NotNull] ModelMetadata metadata)
            {
                Metadata = metadata;
                SelectListItems = base.GetSelectList(metadata);

...
namespace Microsoft.AspNet.Mvc.Rendering
{
    ...
    public interface IHtmlHelper
    {
        ...
        /// <returns>
        /// An IEnumerable{SelectListItem} containing the select list for the given <typeparamref name="TEnum"/>.
        /// </returns>
        /// <exception cref="ArgumentException">
        /// Thrown if <typeparamref name="TEnum"/> is not an <see cref="Enum"/> or if it has a
        /// <see cref="FlagsAttribute"/>.
        /// </exception>
        IEnumerable<SelectListItem> GetSelectList<TEnum>() where TEnum : struct;
        ...
        /// <returns>
        /// An IEnumerable{SelectListItem} containing the select list for the given <paramref name="enumType"/>.
        /// </returns>
        /// <exception cref="ArgumentException">
        /// Thrown if <paramref name="enumType"/> is not an <see cref="Enum"/> or if it has a
        /// <see cref="FlagsAttribute"/>.
        /// </exception>
        IEnumerable<SelectListItem> GetSelectList([NotNull] Type enumType);
